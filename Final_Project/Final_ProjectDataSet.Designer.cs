...
namespace Final_Project {
    ...
    public partial class Final_ProjectDataSet : global::System.Data.DataSet {
        ...
        public partial class ActivitiesDataTable : global::System.Data.TypedTableBase<ActivitiesRow> {
            ...
            private global::System.Data.DataColumn columnNeed_Count;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public global::System.Data.DataColumn Need_CountColumn {
                get {
                    return this.columnNeed_Count;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ActivitiesRow AddActivitiesRow(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, System.DateTime stamp, string Address, int ID) {
            ...
            internal void InitVars() {
                ...
                this.columnNeed_Count = base.Columns["Need_Count"];
            ...
            private void InitClass() {
                ...
                this.columnNeed_Count = new global::System.Data.DataColumn("Need_Count", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnNeed_Count);
                ...
                this.columnNeed_Count.AllowDBNull = false;
        ...
        public partial class ActivitiesRow : global::System.Data.DataRow {
            ...
            public int Need_Count {
                get {
                    return ((int)(this[this.tableActivities.Need_CountColumn]));
                }
                set {
                    this[this.tableActivities.Need_CountColumn] = value;
                }
            }
...
namespace Final_Project.Final_ProjectDataSetTableAdapters {
    ...
    public partial class ActivitiesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Need_Count", "Need_Count");
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Activities] WHERE (([Place] = @Original_Place) AND ([Need_Count] = @Original_Need_Count) AND ([MainUserId] = @Original_MainUserId) AND ([EstimateTime] = @Original_EstimateTime) AND ([stamp] = @Original_stamp) AND ([Address] = @Original_Address) AND ([ID] = @Original_ID))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Need_Count", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Need_Count", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Activities] ([Place], [Need_Count], [MainUserId], [EstimateTime], [stamp], [Address], [ID]) VALUES (@Place, @Need_Count, @MainUserId, @EstimateTime, @stamp, @Address, @ID);
SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address, ID FROM Activities WHERE (MainUserId = @MainUserId)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Need_Count", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Need_Count", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Activities] SET [Place] = @Place, [Need_Count] = @Need_Count, [MainUserId] = @MainUserId, [EstimateTime] = @EstimateTime, [stamp] = @stamp, [Address] = @Address, [ID] = @ID WHERE (([Place] = @Original_Place) AND ([Need_Count] = @Original_Need_Count) AND ([MainUserId] = @Original_MainUserId) AND ([EstimateTime] = @Original_EstimateTime) AND ([stamp] = @Original_stamp) AND ([Address] = @Original_Address) AND ([ID] = @Original_ID));
SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address, ID FROM Activities WHERE (MainUserId = @MainUserId)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Need_Count", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Need_Count", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Need_Count", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Need_Count", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address, ID FROM dbo.A" +
                "ctivities";
        ...
        public virtual int Delete(string Original_Place, int Original_Need_Count, string Original_MainUserId, System.DateTime Original_EstimateTime, System.DateTime Original_stamp, string Original_Address, int Original_ID) {
            ...
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_Need_Count));
            if ((Original_MainUserId == null)) {
                throw new global::System.ArgumentNullException("Original_MainUserId");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_MainUserId));
            }
            this.Adapter.DeleteCommand.Parameters[3].Value = ((System.DateTime)(Original_EstimateTime));
            this.Adapter.DeleteCommand.Parameters[4].Value = ((System.DateTime)(Original_stamp));
        ...
        public virtual int Insert(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, System.DateTime stamp, string Address, int ID) {
            if ((Place == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(Need_Count));
            if ((MainUserId == null)) {
                throw new global::System.ArgumentNullException("MainUserId");
            }
            else {
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(MainUserId));
            }
            this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(EstimateTime));
            this.Adapter.InsertCommand.Parameters[4].Value = ((System.DateTime)(stamp));
            if ((Address == null)) {
        ...
        public virtual int Update(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, System.DateTime stamp, string Address, int ID, string Original_Place, int Original_Need_Count, string Original_MainUserId, System.DateTime Original_EstimateTime, System.DateTime Original_stamp, string Original_Address, int Original_ID) {
            if ((Place == null)) {
                throw new global::System.ArgumentNullException("Place");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Need_Count));
            if ((MainUserId == null)) {
                throw new global::System.ArgumentNullException("MainUserId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(MainUserId));
            }
            this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(EstimateTime));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(stamp));
            if ((Address == null)) {
                throw new global::System.ArgumentNullException("Address");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_Need_Count));
            if ((Original_MainUserId == null)) {
                throw new global::System.ArgumentNullException("Original_MainUserId");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_MainUserId));
            }
            this.Adapter.UpdateCommand.Parameters[10].Value = ((System.DateTime)(Original_EstimateTime));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((System.DateTime)(Original_stamp));
            if ((Original_Address == null)) {
                throw new global::System.ArgumentNullException("Original_Address");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Place, int Need_Count, System.DateTime EstimateTime, System.DateTime stamp, string Address, int ID, string Original_Place, int Original_Need_Count, string Original_MainUserId, System.DateTime Original_EstimateTime, System.DateTime Original_stamp, string Original_Address, int Original_ID) {
            return this.Update(Place, Need_Count, Original_MainUserId, EstimateTime, stamp, Address, ID, Original_Place, Original_Need_Count, Original_MainUserId, Original_EstimateTime, Original_stamp, Original_Address, Original_ID);
        }
    }

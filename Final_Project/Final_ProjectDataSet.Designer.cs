...
namespace Final_Project {
    ...
    public partial class Final_ProjectDataSet : global::System.Data.DataSet {
        ...
        public partial class ActivitiesDataTable : global::System.Data.TypedTableBase<ActivitiesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ActivitiesRow AddActivitiesRow(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, byte[] stamp, string Address) {
        ...
        public partial class ChatDataTable : global::System.Data.TypedTableBase<ChatRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ChatRow AddChatRow(int ActivityID, string SenderID, byte[] Time, string Content) {
        ...
        public partial class ActivitiesRow : global::System.Data.DataRow {
            ...
            public byte[] stamp {
                get {
                    return ((byte[])(this[this.tableActivities.stampColumn]));
                }
                set {
        ...
        public partial class ChatRow : global::System.Data.DataRow {
            ...
            public byte[] Time {
                get {
                    return ((byte[])(this[this.tableChat.TimeColumn]));
                }
                set {
...
namespace Final_Project.Final_ProjectDataSetTableAdapters {
    ...
    public partial class ActivitiesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Activities] WHERE (([MainUserId] = @Original_MainUserId) AND (" +
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Activities] ([Place], [Need_Count], [MainUserId], [EstimateTime], [Address]) VALUES (@Place, @Need_Count, @MainUserId, @EstimateTime, @Address);
SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address FROM Activities WHERE (MainUserId = @MainUserId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Activities] SET [Place] = @Place, [Need_Count] = @Need_Count, [MainUserId] = @MainUserId, [EstimateTime] = @EstimateTime, [Address] = @Address WHERE (([MainUserId] = @Original_MainUserId) AND ([stamp] = @Original_stamp));
SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address FROM Activities WHERE (MainUserId = @MainUserId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Final_Project.Properties.Settings.Default.Final_ProjectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Place, Need_Count, MainUserId, EstimateTime, stamp, Address FROM dbo.Activ" +
                "ities";
        ...
        public virtual int Delete(string Original_MainUserId, byte[] Original_stamp) {
            if ((Original_MainUserId == null)) {
                throw new global::System.ArgumentNullException("Original_MainUserId");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[0].Value = ((string)(Original_MainUserId));
            }
        ...
        public virtual int Insert(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, string Address) {
            if ((Place == null)) {
        ...
        public virtual int Update(string Place, int Need_Count, string MainUserId, System.DateTime EstimateTime, string Address, string Original_MainUserId, byte[] Original_stamp) {
            if ((Place == null)) {
                throw new global::System.ArgumentNullException("Place");
            }
            else {
            ...
            if ((Original_MainUserId == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_MainUserId));
            }
            if ((Original_stamp == null)) {
                throw new global::System.ArgumentNullException("Original_stamp");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[6].Value = ((byte[])(Original_stamp));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Place, int Need_Count, System.DateTime EstimateTime, string Address, string Original_MainUserId, byte[] Original_stamp) {
            return this.Update(Place, Need_Count, Original_MainUserId, EstimateTime, Address, Original_MainUserId, Original_stamp);
        }
    }
    ...
    public partial class ChatTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Chat] WHERE (([ActivityID] = @Original_ActivityID) AND ([Time]" +
                " = @Original_Time))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Chat] ([ActivityID], [SenderID], [Content]) VALUES (@ActivityI" +
                "D, @SenderID, @Content);\r\nSELECT ActivityID, SenderID, Time, [Content] FROM Chat" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Chat] SET [ActivityID] = @ActivityID, [SenderID] = @SenderID, [Content] = @Content WHERE (([ActivityID] = @Original_ActivityID) AND ([Time] = @Original_Time));
SELECT ActivityID, SenderID, Time, [Content] FROM Chat WHERE (ActivityID = @ActivityID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_ActivityID, byte[] Original_Time) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int ActivityID, string SenderID, string Content) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ActivityID, string SenderID, string Content, int Original_ActivityID, byte[] Original_Time) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string SenderID, string Content, int Original_ActivityID, byte[] Original_Time) {
            return this.Update(Original_ActivityID, SenderID, Content, Original_ActivityID, Original_Time);
        }
    }
